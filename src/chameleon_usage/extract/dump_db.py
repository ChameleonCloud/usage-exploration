...
TABLES = {
    ...
    "openstack_audit": [
        ...
        "audit_ironic_nodes",
        "audit_blazar_leases",
        "audit_blazar_reservations",
        "audit_blazar_computehost_allocations",
        "audit_blazar_computehost_reservations",
        "audit_blazar_instance_reservations",
        "audit_blazar_device_allocations",
        "audit_blazar_device_reservations",
        "audit_blazar_devices",
        "audit_blazar_device_extra_capabilities",
    ],
    "chameleon_usage": [
